...
Choose a pace at the start — **Fine** (stop every step), **Balanced** (every 3), or **Fast** (every 5). Steps stay small and atomic; pace only changes how often Claude pauses for sign-off.
